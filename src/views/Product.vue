            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="product-pic-zoom">
                  <img class="product-big-img" :src="gambar_photo" alt="" />
                </div>
                <div class="product-thumbs">
                  ...
                  >
                    <div
                      ...
                      :class="thumbs[0] == gambar_photo ? 'active' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[1] == gambar_photo ? 'active' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[2] == gambar_photo ? 'active' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[3] == gambar_photo ? 'active' : ''"
                    >
              ...
              <div class="col-lg-6">
                <div class="product-details text-left">
                  ...
                  <div class="pd-desc">
                    ...
                    <h4 class="text-justify">$495.00</h4>
                  </div>
                  <div class="quantity">
...
<script>
// @ is an alias to /src
import HeaderShayana from "@/components/HeaderShayana.vue";
import FooterShayana from "@/components/FooterShayana.vue";
import carousel from "vue-owl-carousel";
import RelatedShayana from "@/components/RelatedShayana.vue";
